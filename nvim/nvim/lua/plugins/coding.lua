return {
  ...
  --[[ Treesitter for Syntax Highlighting and More ]]
  {
    ...
    event = { "BufReadPre", "BufNewFile" }, -- Load when opening files for highlighting
    build = ":TSUpdate",                    -- Auto-run TSUpdate on build/update
    main = "nvim-treesitter.configs",       -- Specifies the main module for setup
    opts = {
      ensure_installed = {
    ...
    -- lazy.nvim will call require("nvim-treesitter.configs").setup(opts)
  },
  ...
  --[[ LSP Configuration ]]
  {
    ...
    config = function()
      ...
      local function toggle_inline_diagnostics()
        ...
        vim.notify("Inline diagnostics: " .. (inline_diagnostics_enabled and "ON" or "OFF"),
          vim.log.levels.INFO, { title = "Diagnostics" })
      end

      -- Keymap for toggling inline diagnostics
      vim.keymap.set('n', '<leader>td', toggle_inline_diagnostics,
      ...
      local on_attach = function(client, bufnr)
        ...
        vim.keymap.set('n', '<leader>ds', vim.diagnostic.open_float, keymap_opts("Diagnostics: Show Line Diagnostics"))
        ...
        handlers = {
          ...
          ["tailwindcss"] = function()
            lspconfig.tailwindcss.setup({
              on_attach = on_attach,
              capabilities = capabilities,
              filetypes = { "typescriptreact", "javascriptreact", "html", "css", "astro", "vue", "svelte", "eruby" },
